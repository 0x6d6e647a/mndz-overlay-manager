...
Bun deps cache tarball from GitHub tag, `engines.bun` probing, bun-bin BDEPEND, overlay bun-bin ceilings, host Bun gate, and `dev-util/ralph-tui` enablement under `DepsAndAssets Bun`.
