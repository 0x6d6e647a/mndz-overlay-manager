...
- **WHEN** sidecars are committed and then a later assets commit lands on `main` before the GitHub release is created
- **THEN** the new tag still names the commit that added those sidecars
