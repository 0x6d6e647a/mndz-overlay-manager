# dev-db-badger-seed Specification

## Purpose

Requirements for the manually seeded `dev-db/badger` overlay package (v4.9.4), including vendor assets, jemalloc private build, USE flags, and operator smoke acceptance. This is overlay/seed product truth, not mndz-overlay-manager runtime behavior.
