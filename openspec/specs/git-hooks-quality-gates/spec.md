...
The repository SHALL include a weeder configuration that defines roots appropriate to this package (including executable and test entrypoints as needed) so dead-code analysis is meaningful for a library-plus-executable layout.
