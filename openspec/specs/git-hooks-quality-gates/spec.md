...
Define project quality gates enforced via hk git hooks and check entrypoints: Cabal-managed local tools, strict bootstrap, blocking format / non-coverage build / coverage-enabled test+report / lint / analysis pipeline, and HIE support for stan and weeder.
