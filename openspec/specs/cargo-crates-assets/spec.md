...
Cargo ecosystem under `DepsAndAssets`: pycargoebuild crate-tarball materialize, distfile naming, MSRV probe, SRC_URI/`RUST_MIN_VER` ownership, policy for hk/mise/usage, preflight tools, and reuse vs full path.
