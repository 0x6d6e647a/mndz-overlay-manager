...
- **WHEN** the user runs any of `list --help`, `outdated --help`, or `update --help`
...
Top-level usage/help text SHALL list the work subcommands `list`, `outdated`, and `update` and SHALL NOT list a `help` subcommand.
