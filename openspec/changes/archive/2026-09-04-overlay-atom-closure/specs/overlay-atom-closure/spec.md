...
- **WHEN** `dev-util/ralph-tui` to-be-written `BDEPEND` contains `>=dev-lang/bun-bin-1.3.6`
...
- **WHEN** ralph-tui `BDEPEND` contains `>=dev-lang/bun-bin-1.3.6` and overlay bun-bin’s newest non-live PV is `1.4.1`
- **THEN** the atom is satisfiable
